...
>
    ...
    <Button size="large" type="primary" htmlType="submit" style={{paddingInline: 50, backgroundColor:"lightgreen"}}>
    Вхід
    </Button>
    </Form.Item>
    ...
    Немає аккаунта? <Link style={{color:"lightgreen"}} to="/register">Створити зараз!</Link>
        </Typography>
        </Form.Item>
        </Form>
        </Flex>
